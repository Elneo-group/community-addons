{
    "name": "Row Number in tree/list view for Purchase",
    "version": "17.0.1.0.0",
    "summary": "Show row number in tree/list view for Purchase.",
    "category": "Other",
    ...
    "depends": ["purchase", "rowno_in_tree"],
    "data": [],
    "assets": {
        "web.assets_backend": [
            "rowno_in_tree_purchase/static/src/xml/list_render.xml",
        ],
    },
