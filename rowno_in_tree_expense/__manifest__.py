{
    "name": "Row Number in tree/list view for Expence",
    "version": "17.0.1.0.0",
    "summary": "Show row number in tree/list view for Expence.",
    "category": "Other",
    ...
    "depends": ["rowno_in_tree", "hr_expense"],
    "data": [],
    "assets": {
        "web.assets_backend": [
            "/rowno_in_tree_expense/static/src/xml/list_render.xml"
        ],
    },
