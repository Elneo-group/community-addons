{
    "name": "Row Number in tree/list view for Stock",
    "version": "17.0.1.0.0",
    "summary": "Show row number in tree/list view for Stock.",
    "category": "Other",
    ...
    "depends": ["stock", "rowno_in_tree"],
    "data": [],
    "assets": {
        "web.assets_backend": [
            "rowno_in_tree_stock/static/src/xml/list_render.xml",
        ],
    },
